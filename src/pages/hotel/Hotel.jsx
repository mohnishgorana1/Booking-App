...
import { FaLocationDot, FaCircleXmark } from "react-icons/fa6";
    ...
    <div>
      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          ...
          <h1 className="hotelAddress">
            <FaLocationDot />
            <span className="">Elton 125 New York </span>
          </h1>
          ...
          <div className="hotelImages">
            {photos.map((photo, index) => (
              <div className="hotelWrapper" key={photo.src}>
                <img
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              <h1 className="hotelTitle">Stay in heart of lucknow</h1>
